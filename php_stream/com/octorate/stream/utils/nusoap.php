...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function call($xmlContent,$operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
		...
		$return = $this->send($soapmsg,$soapAction,$this->timeout,$this->response_timeout);
